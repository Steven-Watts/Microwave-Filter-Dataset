...
lifetime=s:rebuild
result=s:1
treepath=s:Farfields\farfield (f=0.8) [1]
files=s:farfield (f=0.8)_1.ffm
ylabel=s:farfield (f=0.8) [1]
...
lifetime=s:rebuild
result=s:1
treepath=s:Farfields\farfield (f=1.2) [1]
files=s:farfield (f=1.2)_1.ffm
ylabel=s:farfield (f=1.2) [1]
